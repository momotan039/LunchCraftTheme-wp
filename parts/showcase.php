            ...
            <div class="showcase-slider owl-carousel">
              <div class="item">
                <div class="screenshot-thumb">
                  <img src="<?php echo get_template_directory_uri(  );?>/assets/img/showcase/01.jpg" class="img-fluid" alt="" />
              ...
              <div class="item">
                <div class="screenshot-thumb">
                  <img src="<?php echo get_template_directory_uri(  );?>/assets/img/showcase/02.jpg" class="img-fluid" alt="" />
                  <div class="hover-content text-center">
                    <div class="fancy-table">
                      <div class="table-cell">
                        <div class="single-text">
              ...
              <div class="item">
                <div class="screenshot-thumb">
                  <img src="<?php echo get_template_directory_uri(  );?>/assets/img/showcase/03.jpg" class="img-fluid" alt="" />
                  <div class="hover-content text-center">
                    <div class="fancy-table">
                      <div class="table-cell">
                        <div class="single-text">
              ...
              <div class="item">
                <div class="screenshot-thumb">
                  <img src="<?php echo get_template_directory_uri(  );?>/assets/img/showcase/04.jpg" class="img-fluid" alt="" />
                  <div class="hover-content text-center">
                    <div class="fancy-table">
                      <div class="table-cell">
                        <div class="single-text">
              ...
              <div class="item">
                <div class="screenshot-thumb">
                  <img src="<?php echo get_template_directory_uri(  );?>/assets/img/showcase/05.jpg" class="img-fluid" alt="" />
                  <div class="hover-content text-center">
                    <div class="fancy-table">
                      <div class="table-cell">
                        <div class="single-text">
